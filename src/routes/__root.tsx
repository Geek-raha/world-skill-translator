...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Skill Passport translates informal skills into a formal UNMAPPED." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Skills-Passport" },
      { property: "og:description", content: "Skill Passport translates informal skills into a formal UNMAPPED." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Skills-Passport" },
      { name: "twitter:description", content: "Skill Passport translates informal skills into a formal UNMAPPED." },
